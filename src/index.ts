export { DateInput } from "./base/date-input";
export type {
	DateInputIcon as BaseDateInputIcon,
	DateInputIcons as BaseDateInputIcons,
	DateInputProps as BaseDateInputProps,
	DateRange as BaseDateRange,
} from "./base/date-input";
...
export type {
	DateInputIcon as RadixDateInputIcon,
	DateInputIcons as RadixDateInputIcons,
	DateInputProps as RadixDateInputProps,
	DateRange as RadixDateRange,
} from "./radix/date-input";
